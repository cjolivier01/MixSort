...
OMP_NUM_THREADS=16 \
  ./p tools/train.py --resume --start_epoch=6 -f exps/example/mot/yolox_x_hockey_train.py -d 8 -b 64 --fp16 -c YOLOX_outputs/yolox_x_hockey_train/latest_ckpt.pth.tar $@
