...
class KalmanFilter(object):
    ...
    def initiate(self, measurement):
        ...
        std = torch.tensor([
            ...
            10 * self._std_weight_velocity * measurement[3],
            1e-5,
            10 * self._std_weight_velocity * measurement[3]], dtype=torch.float32, device=mean.device)
    ...
    def predict(self, mean, covariance):
        ...
        std_vel = [
            ...
            1e-5,
            self._std_weight_velocity * mean[3]]
        motion_cov = torch.diag(torch.square(torch.r_[std_pos, std_vel]))
