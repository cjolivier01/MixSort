...
class EnvironmentSettings:
    def __init__(self):
        ...
        self.hockey_dir = f"{self.dataset_dir}/hockeyTraining"
        self.hockey_anno_dir = f"{self.dataset_dir}/hockeyTraining/tracking_annos"
        self.hockey_ch_ht_dir = f"{self.dataset_dir}/hockeyTraining"
        self.hockey_ch_ht_anno_dir = f"{self.dataset_dir}/hockeyTraining/tracking_annos"
        self.lasot_dir = ""
        self.tnl2k_dir = ""
        self.got10k_dir = ""
